        ...
        for i in range(len(stock_df)):
            ...
            if i%22 == 0:
                ...
                if dif_pb < 0:  
                    ...
                    result_list.append([trade_date,dif_pb,close,thismoney,0,totalbuymoney,totalsellmoney,totalvolume])
                ...
                #当前pb大于ndays天pb均线，卖    
                    ...
                    #resultcsvtitle = ['操作日期','PB-PB*','本次单价','本次买入金额','本次卖出金额','累计买入金额','累计卖出金额','股票剩余资产']
                    result_list.append([trade_date,dif_pb,close,0,thismoney,totalbuymoney,totalsellmoney,totalvolume])
